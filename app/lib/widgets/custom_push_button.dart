...
/// The sizes a [CustomPushButton] can be.
enum CustomButtonSize {
  /// A large [CustomPushButton].
  large,

  /// A small [CustomPushButton].
  small,
}
...
/// {@template CustompushButton}
/// A macOS-style button.
/// {@endtemplate}
class CustomPushButton extends StatefulWidget {
  /// {@macro CustompushButton}
  ...
  ///
  /// Ignored if the [CustomPushButton] doesn't also have a [color].
  ///
  ...
  ///
  /// Sets its background color to [CustomPushButtonThemeData]'s [secondaryColor] attributes (defaults
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<CustomButtonSize>('buttonSize', buttonSize));
  ...
  @override
  CustomPushButtonState createState() => CustomPushButtonState();
}

class CustomPushButtonState extends State<CustomPushButton>
  ...
  @override
  void didUpdateWidget(CustomPushButton oldWidget) {
