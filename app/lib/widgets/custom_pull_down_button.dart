...
class _CustomMacosPulldownMenuItemButton extends StatefulWidget {
  // ignore: use_super_parameters
  const _CustomMacosPulldownMenuItemButton({
    Key? key,
    this.padding,
    required this.route,
  ...
  @override
  _CustomMacosPulldownMenuItemButtonState createState() =>
      _CustomMacosPulldownMenuItemButtonState();
}

class _CustomMacosPulldownMenuItemButtonState
    extends State<_CustomMacosPulldownMenuItemButton> {
  ...
  void _handleOnTap() {
    ...
    if (menuEntity is CustomMacosPulldownMenuItem) {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> children = <Widget>[
      for (int itemIndex = 0; itemIndex < route.items.length; ++itemIndex)
        _CustomMacosPulldownMenuItemButton(
          route: widget.route,
          padding: widget.padding,
...
/// [CustomMacosPulldownMenuItem] or a [MacosPulldownMenuDivider].
...
/// widget.
class CustomMacosPulldownMenuItem extends StatelessWidget
    implements MacosPulldownMenuEntry {
  /// Creates an item for a macOS-style pulldown menu.
  const CustomMacosPulldownMenuItem({
    super.key,
    required this.title,
    this.onTap,
    this.enabled = true,
...
/// See also:
///
///  * [CustomMacosPulldownMenuItem], the class used to represent the menu options.
...
class CustomMacosPulldownButton extends StatefulWidget {
  ...
  ///
  /// Can be either [CustomMacosPulldownMenuItem]s or [MacosPulldownMenuDivider]s.
  ///
  ...
  @override
  State<CustomMacosPulldownButton> createState() =>
      _CustomMacosPulldownButtonState();
}

class _CustomMacosPulldownButtonState extends State<CustomMacosPulldownButton>
...
// macOS Design Guidelines and the current CustomMacosPulldownButtonTheme.
